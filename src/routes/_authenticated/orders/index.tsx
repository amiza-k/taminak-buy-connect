...
function OrdersPage() {
  ...
  return (
    <PageShell title="سفارش‌های من" description="وضعیت سفارش‌های ثبت‌شده برای هر تأمین‌کننده">
      <div className="pb-24 md:pb-0">
        {orgPending ? (
          ...
          <div className="rounded-xl border border-dashed border-border bg-card p-12 text-center">
            ...
            <p className="mt-4 text-sm text-muted-foreground">هنوز سفارشی ثبت نشده است.</p>
          </div>
        ) : (
